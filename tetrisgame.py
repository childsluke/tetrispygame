...
#
# TODO: Line Clearing, Tetris 'bag' randomnisation algorithm, fix x axis intersection with collision detection
...
def main():
    ...
    while gameRunning:
        ...
        pygame.draw.line(gameSurface, (255,255,255), (500, 0), (500,640), 2)
        ...
        while activeTetrisBlockCounter < 4 and len(blocksOnScreen) > 0:
            ...
            if(blocksOnScreen[currentIteration].position.y >= 640 - blockSize):
                blocksOnScreen[currentIteration].downwardVelocity = 0
                blocksOnScreen[currentIteration].position.y = 640 - blockSize
            ...
            while(wallTestCounter < 4):
                ...
                if blocksOnScreen[currentWallTestIteration].position.x <= 0:
                    ...
                    blocksOnScreen[currentIteration].position.x += leftRightMovementFactor * 2
                    break
            ...
            while(collisionTestCounter < len(blocksOnScreen) - 4):
                if blocksOnScreen[currentIteration].collisionTest(blocksOnScreen[collisionTestCounter]):
                    ...
                    while collisionApplyCounter <= 4:
                        ...
                        blocksOnScreen[len(blocksOnScreen) - collisionApplyCounter].position.y -= velocityFactor
                        collisionApplyCounter += 1
                    allBlocksStopped = True
                    break
        ...
        if pressed[pygame.K_DOWN] and velocityFactor < 2.5 and not downPressed:
            velocityFactor = 2.5
            downPressed = True       
        ...
        for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if(event.key ==  pygame.K_ESCAPE):
                        gameRunning = False
                    # TODO: Space bar rotates active Tetris block 90 degrees
